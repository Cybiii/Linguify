...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl uppercase tracking-wide font-bold text-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        locked:
        ...
        sidebar:
          "bg-transparent text-slate-500 broder-2 border-transparent hover:bg-slate-100 transition-none",
        sidebarOutline:
